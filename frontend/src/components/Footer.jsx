    ...
    <footer className="bg-zinc-950 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              />
              <span className="font-bold text-xl">Mavryk</span>
            </div>
            <p className="text-zinc-400 mb-6">
              Your growth partner that delivers real results through data-driven
              creativity and strategic marketing solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-zinc-400">+91 94831 76529</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="text-purple-500 h-5 w-5 flex-shrink-0" />
                <span className="text-zinc-400">work.shubhamdas@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center text-zinc-500 text-sm">
          &copy; {new Date().getFullYear()} Mavryk. All rights reserved.
        </div>
      </div>
    </footer>
  );
