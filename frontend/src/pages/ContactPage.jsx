        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-zinc-300 mb-8">
              Ready to boost your business growth? Book a free consultation call
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="bg-purple-600 hover:bg-purple-700 text-white py-3 px-8 rounded-lg font-medium transition-all duration-300 inline-block"
              >
                Book a Free Call
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <motion.p variants={itemVariants} className="text-zinc-400 mb-8">
                Have questions or ready to start a project? Reach out to us
                through any of the following channels or fill out the contact
                form.
              </motion.p>
              ...
              <motion.div variants={itemVariants} className="space-y-6 mb-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">work.shubhamdas@gmail.com</p>
                    <p className="text-zinc-400">mavryk@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">+91 94831 76529</p>
                    <p className="text-zinc-400">+91 87652 94310</p>
                  </div>
                </div>
              </motion.div>
